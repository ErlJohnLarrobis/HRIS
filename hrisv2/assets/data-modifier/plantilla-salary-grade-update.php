...
<body>
        ...
        <section class="content" style="height: 100vh;">
            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px;">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $sql = "UPDATE salary_grades SET sg_number='$sg_no', sg_remark='$description', sg_order='$order', sg_encode_date=NOW() WHERE sg_no=$id";
                    ...
                    if ($result) {
                        ...
                        setTimeout(function() {
                          ...
                          echo '<script>
                            setTimeout(function() {
                            window.location.href = "/hrisv2/assets/sub-links/plantilla-salary-grade.php";
                            }, 1000);
                            </script>';
                        exit;
                      } else {
                  ...
                  if(isset($_GET['id'])){
                    $getid = $_GET['id'];
                    $getsql = "SELECT * FROM salary_grades WHERE sg_no=$getid";
                ...
                ?>
                <form class="row justify-content-center needs-validation mb-5 pt-5" method='POST' action='' novalidate>
                    <div class="mb-3 col-8">
                        <input type="hidden" name="id" value="<?php echo $getid ?>">
                        <label for="simpleinput" class="form-label">SG #:</label>
                        <input type="text" id="sg_no" name="sg_no" class="form-control"value="<?php echo $row['sg_number'] ?>" required>
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <input type="text" id="description" name="description"value="<?php echo $row['sg_remark'] ?>" class="form-control">
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Order:</label>
                        <input type="text" id="order" name="order"value="<?php echo $row['sg_order'] ?>" class="form-control" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-8">
                        ...
                        <button type="button" class="btn btn-danger" onclick="toclose()">Close</button>
                    </div>
                </form>
            </div>
        </section>
    ...
    <script>
        function toclose(){
            window.location.href="../sub-links/plantilla-salary-grade.php";
        }
    </script>
</body>
</html>