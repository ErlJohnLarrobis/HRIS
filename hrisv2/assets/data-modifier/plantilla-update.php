...
<body>
        ...
        <section class="content" style="height: 100vh;">
            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px;">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $sql = "UPDATE positions SET sg_no='$sg', position_code='$code', position_title='$name', position_type='$type' WHERE position_no=$update_id";
                    ...
                    if ($result) {
                        ...
                        echo '<script>
                            setTimeout(function() {
                            window.location.href = "/hrisv2/assets/links/plantilla.php";
                            }, 1500);
                            </script>';
                        exit;
                    } else {
                ...
                elseif(isset($_GET['id'])) {
                    $id = $_GET['id'];
                    $query = "SELECT * FROM positions WHERE position_no=$id;";
                    $result = mysqli_query($conn, $query);
                    $row = mysqli_fetch_assoc($result);
                    $getsg = $row['sg_no'];
                    $getcode = $row['position_code'];
                    $getname = $row['position_title'];
                    $gettype = $row['position_type'];
                  }
                ?>
                <form class="row justify-content-center needs-validation mb-5 pt-5" novalidate method="post" action="">
                    <div class="mb-3 col-8">
                        ...
                        <select class="form-select" id="salary-grade" name="salary-grade" required>
                            <option selected value="<?php echo $getsg ?>"><?php echo $getsg ?></option>
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <input type="text" id="code" name="code" class="form-control" value="<?php echo $getcode ?>" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <input type="text" id="name" name="name" class="form-control" value="<?php echo $getname ?>" required>
                        <div class="invalid-feedback">
    ...
    <script>
        function toclose(){
            window.location.href = "../links/plantilla.php";
        }
    </script>
</body>
</html>