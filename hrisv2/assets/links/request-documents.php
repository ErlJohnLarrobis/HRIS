        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                ...
                <ul class="nav nav-pills">
                    <li>
                        <a href="/hrisv2/assets/links/request-documents.php" class="nav-link bg-white">Request</a>
                    </li>
                    <li>
                ...
                <div class="table">
                    <table id="data-table" class="table table-hover mt-5">
                        ...
                        <?php
                            ...
                            $sql = "SELECT * FROM employee_requests";
                            ...
                            <tr>
                                <td><?php echo htmlentities($row['user_no']) ?></td>
                                <td><?php echo htmlentities($row['erequest_reason']) ?></td>
                                <td><?php echo htmlentities($row['erequest_date']) ?></td>
                                <td><?php echo htmlentities($row['erequest_time']) ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
