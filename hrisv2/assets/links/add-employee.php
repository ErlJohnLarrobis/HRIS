    ...
    <div class="content-container" id="collapse">
        <div class="sidebar d-flex flex-column flex-shrink-0 bg-light shadow">
            <div class="sidebar-header">
                ...
                <button class="btn btn-primary float-end mt-2" onclick="collapse()" type="button"><i class="bi bi-list"></i></button>
            </div>
            <hr>
                    ...
                    <tbody>
                        <?php 
                            ...
                            $sql="select * from users a 
                                join employee_jobhistory b on a.user_no = b.user_no
                                join departments c on b.depart_no = c.depart_no
                                join positions d on b.position_no = d.position_no
                                left join campuses e on a.campus_no = e.campus_no
                                left join departments_groups f on b.dgroup_no = f.dgroup_no
                                where job_end is null and job_delete = 0 and user_delete = 0 and user_inactive = 0
                                group by a.user_no
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlentities($row["depart_title"])?></td>
