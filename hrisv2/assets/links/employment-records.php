    ...
    <div class="content-container" id="collapse">
        <div class="sidebar d-flex flex-column flex-shrink-0 bg-light shadow">
            ...
            <ul class="nav nav-pills flex-column mb-auto d-block">
                ...
                <li>
                    <a href="/hrisv2/assets/links/employment-records.php" class="nav-link text-white active">
        ...
        <section class="content">
            <div class="header bg-primary p-3">
                <p class="fs-3 text text-white">Employment Records</p>
            </div>
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px; min-height: 220px;">
                <form id="search" class="row justify-content-center needs-validation mb-5 pt-5" novalidate>
                    <div class="mb-3 col-8">
                        ...
                        <div class="input-group">
                            ...
                            <button onclick="search()" class="btn btn-primary">View</button>
                            <button class="btn btn-success rounded-end">Advance</button>
                ...
                <div class="mt-5" id="result" style="display:none;"> 
                    <div class="d-sm-flex justify-content-center gap-3">
                        <img src="/hrisv2/assets/images/profile.png" class="img-thumbnail" alt="Cinque Terre" width="200" height="200">
                        <div>
                            <h6>Last Name, First Name (ID)</h6>
                            <h6>Position:</h6>
                            <h6>Department/Office:</h6>
                            <h6>Years of Service:</h6>
                            <br>
                            <button type="button" class="btn btn-primary">Print Records</button> 
                        </div>
                    </div>
                    <hr>
                    <form id="tx" class="row justify-content-center needs-validation mb-5" novalidate>
                            
                        <div class="mb-3 col-8">
                            <label for="simpleinput" class="form-label">Employee ID: (if service record from other government agency.)</label>
                                <input type="text" id="simpleinput" class="form-control" required>
                                <input type="checkbox" class="form-check-input" id="check1" name="option1" value="something">
                                <label class="form-check-label">if checked, service record from other government agency.</label>
                        </div>
                        <div class="mb-3 col-8">
                        ...
                        <div class="mb-3 col-8">
                            <label for="simpleinput" class="form-label">With Designation (or another Position):</label>
                                <input type="text" id="simpleinput" class="form-control" required>
                        </div>
                        <div class="mb-3 col-8">
                            <label for="simpleinput" class="form-label">Branch/Campus</label>
                                <input type="text" id="simpleinput" class="form-control" required>
                        </div>
                        <div class="mb-3 col-8">
                        ...
                        <div class="mb-3 col-8">
                            <label for="simpleinput" class="form-label">Division: (For Government Agency Only)</label>
                                <input type="text" id="simpleinput" class="form-control" required>
                        </div>
                        <div class="mb-3 col-8">
                            <label for="simpleinput" class="form-label">Employment Type:</label>
                                <input type="text" id="simpleinput" class="form-control" required>
                        </div>
                        <div class="mb-3 col-8">
                        ...
                        <div class="mb-3 col-8">
                            <label for="simpleinput" class="form-label">Immediate Supervisor:</label>
                                <input type="text" id="simpleinput" class="form-control" required>
                        </div>
                        <div class="mb-3 col-8">
                            <label for="simpleinput" class="form-label">Salary:</label>
                                <input type="text" id="simpleinput" class="form-control" placeholder="Annual" required>
                                <input type="text" id="simpleinput" class="form-control" placeholder="Month" required>
                                <input type="text" id="simpleinput" class="form-control" placeholder="Day" required>
                                <input type="text" id="simpleinput" class="form-control" placeholder="Hour" required>
                        </div>
                        <div class="mb-3 col-8">
                            <label for="simpleinput" class="form-label">Period:</label>
                                <input type="date" id="simpleinput" class="form-control" required>
                                <input type="date" id="simpleinput" class="form-control" required>
                        </div>
                        <div class="mb-3 col-8">
                            <label for="simpleinput" class="form-label">Separation Cause:</label>
                                <input type="text" id="simpleinput" class="form-control" required><br>
                                <input type="checkbox" class="form-check-input" id="check1" name="option1" value="something">
                                <label class="form-check-label">if checked, service record has no leave credits, or service lapses.</label><br>
                                <input type="checkbox" class="form-check-input" id="check1" name="option1" value="something">
                                <label class="form-check-label">if checked, service record already inactive</label>
                        </div>
                        <div class="col-8">
                            <button type="submit" class="btn btn-success" form="tx">Save</button>
                        </div>
                    </form> 
                </div>
            </div>
