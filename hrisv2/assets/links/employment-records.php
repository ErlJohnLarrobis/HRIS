...
<body>
    <div class="content-container" id="collapse">
        ...
        <section class="content">
            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px; height: 220px;">
            ...
            <br>
            &emsp;<img src="/hrisv2/assets/images/profile.png" class="img-thumbnail" alt="Cinque Terre" width="200" height="200">

     
            <h6>&emsp;Last Name, First Name (ID)</h6>
            <h6>&emsp;Position:</h6>
            <h6>&emsp;Department/Office:</h6>
            <h6>&emsp;Years of Service:</h6>
            <br>
            &emsp;<button type="button" class="btn btn-primary">Print Records</button><hr>  
