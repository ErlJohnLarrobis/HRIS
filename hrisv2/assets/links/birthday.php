    ...
    <div class="content-container" id="collapse">
        <div class="sidebar d-flex flex-column flex-shrink-0 bg-light shadow">
            ...
            <ul class="nav nav-pills flex-column mb-auto d-block">
                ...
                <li>
                    <a href="/hrisv2/assets/links/birthday.php" class="nav-link text-white active">
        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                <p class="fs-3 text text-white">Birthday</p>
                <ul class="nav nav-pills">
                    <li>
                        <a href="/hrisv2/assets/links/birthday.php" class="nav-link bg-white">Birthday</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/birthday_message.php" class="nav-link text-white">Message</a>
                    </li>
                </ul>
            </div>
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -160px;">
                <div class="table">
                    ...
                    <h4>Today's Birthday (<span id="date"></span>)</h4>
                    <table id="data-table" class="table table-hover mt-5">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT user_id, user_fname, user_mname, user_lname, emp_bday FROM `users` JOIN employee_details on users.user_no = employee_details.user_no WHERE emp_bday = DATE_FORMAT(NOW(), '%Y-%m-%d')";
