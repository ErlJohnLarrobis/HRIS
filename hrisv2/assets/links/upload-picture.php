...
<body>
    <div class="content-container" id="collapse">
        <div class="sidebar d-flex flex-column flex-shrink-0 bg-light shadow">
            ...
            <ul class="nav nav-pills flex-column mb-auto d-block">
                ...
                <li>
                    <a href="/hrisv2/assets/links/upload-picture.php" class="nav-link text-white active">
        ...
        <section class="content">
            <div class="header bg-primary p-3">
                <p class="fs-3 text text-white">Upload Picture</p>
            </div>
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px;">
                <form class="row needs-validation justify-content-md-start justify-content-center mb-5 p-5 position-relative" novalidate>
                    ...
                    <div class="mb-3 col-md-4 col-sm-8 position-absolute end-0 d-none d-md-block">
                        <img id="sample-image" src="/hrisv2/assets/images/employee-sample-image.jpg" class="rounded mx-auto d-block border mt-3" alt="profile picture" width="150px">
                    </div>
                    <div class="mb-3 col-8 d-block d-md-none">
                        <img id="sample-image2" src="/hrisv2/assets/images/employee-sample-image.jpg" class="rounded mx-auto d-block border mt-3" alt="profile picture" width="150px">
                    </div>
                    <div class="mb-3 col-8">
    ...
    <script>
        ...
        const sampleImage2 = document.getElementById('sample-image2');
        ...
        imageUpload.addEventListener('change', (event) => {
          ...
          reader.onload = () => {
            sampleImage.src = reader.result;
            sampleImage2.src = reader.result;
          };
        });
      </script>
</body>
