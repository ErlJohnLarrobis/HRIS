    ...
    <div class="content-container" id="collapse">
        <div class="sidebar d-flex flex-column flex-shrink-0 bg-light shadow">
            ...
            <ul class="nav nav-pills flex-column mb-auto d-block">
                ...
                <li>
                    <a href="/hrisv2/assets/links/search.php" class="nav-link text-white active">
        ...
        <section class="content">
            <div class="header bg-primary p-3">
                <p class="fs-3 text text-white">Search</p>
            </div>
                ...
                <form class="row justify-content-center needs-validation mb-5 pt-5" novalidate>
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <div class="input-group">
                            <input type="text" id="simpleinput" class="form-control" placeholder="Lastname" required>
                            <input type="text" id="simpleinput" class="form-control" placeholder="Firstname" required>
                            <div class="invalid-feedback">
                            Please provide a valid Input!
                            </div>
                        </div>
                    ...
                    <div class="mb-3 col-8">
                        <label for="example-select" class="form-label">Blood Type:</label>
                        <select class="form-select" id="campus/branch" required>
                            <option selected disabled value="">N/A</option>
                            <option>1</option>
                            <option>2</option>
                        ...
                        <div class="invalid-feedback">Please provide a valid CInput !</div>
                    </div>
                    <div class="mb-3 col-8">
                        <label for=""><strong>Please select columns that will display in the report:</strong></label>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-check form-check-block">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3">
                                    <label class="form-check-label" for="inlineCheckbox3">Campus/Branch</label>
                                </div>
                                <div class="form-check form-check-block">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3">
                                    <label class="form-check-label" for="inlineCheckbox3">Department/Office</label>
                                </div>
                                <div class="form-check form-check-block">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3">
                                ...
                                <div class="form-check form-check-block">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3">
                                    <label class="form-check-label" for="inlineCheckbox3">Blood Type</label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-check form-check-block">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3">
                                    <label class="form-check-label" for="inlineCheckbox3">Position</label>
                                </div>
                                <div class="form-check form-check-block">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3">
                                    <label class="form-check-label" for="inlineCheckbox3">Employment Type</label>
                                </div>
                                <div class="form-check form-check-block">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3">
                                ...
                                <div class="form-check form-check-block">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3">
                                    <label class="form-check-label" for="inlineCheckbox3">Civil Status</label>
                                    </div>
                                <div class="form-check form-check-block">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3">
                                    <label class="form-check-label" for="inlineCheckbox3">Birthday</label>
                                </div>
                            </div>
                        </div>
                    </div>
