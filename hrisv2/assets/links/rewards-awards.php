                ...
                <form class="row justify-content-center needs-validation mb-5 pt-5" novalidate>
                    <div class="mb-3 col-8">
                        ...
                        <select class="form-select" id="salary-grade" required>
                            ...
                            <option>Exemplary Performance in Instruction</option>
                            <option>Exemplary Performance in Research</option>
                            <option>Exemplary Performance in Extension</option>
                            <option>Outstanding Non-Teaching Personnel - Professional...</option>
                            <option>Outstanding Non-Teaching Personnel - Skilled Perso...</option>
                        </select>
                ...
                <div class="table">
                    <table id="data-table" class="table table-hover mt-5">
                        ...
                        if (mysqli_connect_errno()) {
                            ...
                            $sql="SELECT * FROM `employee_awards` JOIN employee_awards_types ON employee_awards.at_no = employee_awards_types.at_no;";
                            $res = $conn->query($sql);
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $row['award_inactive']?></td>
