            ...
            <?php 
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    if(isset($_POST['delete-button'])){
                        ...
                        $sqldelete = "UPDATE employee_awards SET award_delete=1 WHERE award_no=$id";
                    ...
                    $campus = $_POST['campus'];
                    $title = $_POST['title'];
                    if(isset($_POST['open/close']) && $_POST['open/close'] == 'open'){
                        $value=0;
                    }else{
                        $value=1;
                    }
                    ...
                    $sqlinsert = "INSERT INTO `employee_awards`(`campus_no`, `at_no`, `award_title`, `award_inactive`, `award_encode_date`) 
                    VALUES ('$campus_no','$at_no','$title','$value', NOW())";
            ...
            ?>
                ...
                <div class="table">
                    <table id="data-table" class="table table-hover mt-5">
                        ...
                        ?>
                            <tr>
                                <td><?php echo htmlentities($row['award_title'])?></td>
                                <td><?php echo htmlentities($row['at_title'])?></td>
                                <?php 
                                $active = htmlentities($row['award_inactive']);
                                if ($active == 0) {
                                echo "<td>Open</td>";
                                } else {
                                echo "<td>Closed</td>";
                                ...
                                ?>
                                <td class="d-flex">
                                    <button class="btn btn-success"><a class="text-decoration-none text-dark" href="/hrisv2/assets/data-modifier/rewards-awards-update.php?id=<?php echo $row['award_no']?>">Edit</a></button>&nbsp;
                                    <button class="btn btn-info">nominees</button>&nbsp;
                                    <button class="btn btn-primary">assessment</button>&nbsp;
                                    <form method='post' action='<?php echo $_SERVER['PHP_SELF']; ?>'><input type='hidden' name='delete-button' value='<?php echo $row['award_no'] ?>'><input class="btn btn-danger" type='submit' value='Delete'></form>
                                </td>
                            </tr>
                            <?php
                                endwhile
