                ...
                <form class="row justify-content-center needs-validation mb-5 pt-5" novalidate>
                    <div class="mb-3 col-8" id="search">
                        ...
                        <div class="input-group">
                            <input type="text" id="simpleinput" class="form-control" placeholder="Search for. . ." required>
                    ...
                    <div class="advance mb-3 col-8" id="advance" style="display:none;">
                        <div class="input">
                            <label for="simpleinput" class="form-label">Employee ID:</label>
                            <input type="text" id="simpleinput" name="emp_id" class="form-control" required>
                        </div>
                        <div class="input">
                            <label for="simpleinput" class="form-label">Employee Name:</label>
                            <div class="input-group">
                                <input type="text" id="simpleinput" name="fname" class="form-control" placeholder="firstname" required>
                                <input type="text" id="simpleinput" name="lname" class="form-control" placeholder="lastname" required>
                            </div>
                        </div>
                        <div class="input">
                ...
                <section class="sub-content">
                        <div class="header">
                            <ul class="nav nav-pills">
                                <li>
                                    <a href="/hrisv2/assets/links/plantilla.php" class="nav-link">Personal Data</a>
                                </li>
                                <li>
                                    <a href="/hrisv2/assets/sub-links/plantilla-itemno.php" class="nav-link ">Educational Attainment</a>
                                </li>
                                <li>
                                    <a href="/hrisv2/assets/sub-links/plantilla-salary-grade.php" class="nav-link ">Civil Service Eligibility</a>
                                </li>
                                <li>
                                    <a href="/hrisv2/assets/sub-links/plantilla-step-increment.php" class="nav-link ">Work Experience</a>
                                </li>
                                <li>
                                    <a href="/hrisv2/assets/sub-links/plantilla-sg-table.php" class="nav-link ">Seminars or Trainings Attended</a>
                                </li>
                                <li>
                                    <a href="/hrisv2/assets/sub-links/plantilla-search.php" class="nav-link ">Extra Activities or Services</a>
                                </li>
                                <li>
                                    <a href="/hrisv2/assets/sub-links/plantilla-reports.php" class="nav-link ">Distiction or Recognition</a>
                                </li>
                                <li>
                                    <a href="/hrisv2/assets/sub-links/plantilla-designation.php" class="nav-link ">Group Affiliations</a>
                                </li>
                                <li>
                                    <a href="/hrisv2/assets/sub-links/plantilla-sg-table.php" class="nav-link ">Job Skills and Hobbies</a>
                                </li>
                                <li>
                                    <a href="/hrisv2/assets/sub-links/plantilla-search.php" class="nav-link ">Children's Data</a>
                                </li>
                                <li>
                                    <a href="/hrisv2/assets/sub-links/plantilla-reports.php" class="nav-link ">Upload PDS File</a>
                                </li>
                            </ul>
                            <hr>
                            <div class="row profile">
                                <div class="col-2">
                                <img id="sample-image" src="/hrisv2/assets/images/employee-sample-image.jpg" class="rounded d-block border" alt="profile picture" width="150px">
                                </div> 
                                <div  class=" fs-5 col-10 mt-5">
                        ...
                        <form class="row justify-content-center needs-validation mb-5" novalidate>
                            ...
                            <div class="mb-3 col-8" id="search">
                                ...
                                <div class="input-group">
                                    <input type="text" id="simpleinput" class="form-control" placeholder="xxx-xxx-xxx" required>
                            ...
                            <div class="mb-3 col-8" id="search">
                                ...
                                <div class="input-group">
                                    <input type="text" id="simpleinput" class="form-control" placeholder="xx-xxxxxxx-x" required>
                            ...
                            <div class="mb-3 col-8" id="search">
                                ...
                                <div class="input-group">
                                    <input type="text" id="simpleinput" class="form-control" placeholder="" required>
                            ...
                            <div class="mb-3 col-8" id="search">
                                ...
                                <div class="input-group">
                                    <input type="text" id="simpleinput" class="form-control" placeholder="xx-xxxxxxxxx-x" required>
