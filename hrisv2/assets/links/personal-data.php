                ...
                <form class="row justify-content-center needs-validation mb-5 pt-5" novalidate>
                    <div class="mb-3 col-8" id="search">
                        ...
                        <div class="input-group">
                            ...
                            <button type="submit" class="btn btn-primary"><a href="/hrisv2/assets/sub-links/personal-data_data.php">View</a></button>
                    ...
                    <div class="advance mb-3 col-8" id="advance" style="display:none;">
                        ...
                        <div class="col-8 mt-3">
                            <button class="btn btn-primary" form="tx">Search</button>
                        </div>
                    </div>
                </form>
             </div>
