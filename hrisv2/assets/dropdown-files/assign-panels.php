        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                ...
                <ul class="nav nav-pills">
                    <li>
                        <a href="" class="nav-link bg-white">By Campus</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/by-discipline.php" class="nav-link text-white">By Disciplines</a>
                    </li>
                </ul>
            </div>
            ...
            <?php
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        $panel_encode_date = $_POST['panel_encode_date'];
                        
                        

                        $sql1 = "INSERT INTO employee_applicants_panels (panel_type, panel_encode_date)
                        VALUES ('$panel_type', '$panel_encode_date')";
                        mysqli_query($conn, $sql1);


                        $sql2 = "INSERT INTO users (user_id) VALUES ('$user_id')";
                        mysqli_query($conn, $sql2);

                        $sql3 = "INSERT INTO employee_applicants_assessments (ass_title) VALUES ('$ass_title')";
                ...
                <form class="row justify-content-center needs-validation mb-5 pt-5" novalidate method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                    <div class="mb-3 col-8">
                        ...
                        <select class="form-select" id="assessment" name="ass_title" required>
                            <option selected disabled value="">Select one</option>
                            <?php

                            $sql5 = "SELECT * FROM employee_applicants_assessments";
                            $result1 = mysqli_query($conn, $sql5);
                            while ($row = mysqli_fetch_assoc($result1)) {
                                $assessment = $row["ass_title"];
                                $assdelete = $row["ass_delete"];
                            if($assdelete == '0'){
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <input type="text" id="employeeId" name="user_id" class="form-control" required>
                        <div class="invalid-feedback">Please provide a valid Employee ID !</div>  
                    </div>
                    <div class="mb-3 col-8">
                        <label for="type" class="form-label">Type:</label>
                        <select class="form-select" id="type" name="panel_type" required>
                            <option selected disabled value="">Member</option>
                            <?php
                            $result = mysqli_query($conn, "SELECT * FROM employee_applicants_panels");
                            while ($row = mysqli_fetch_assoc($result)) {
                                $paneltype = $row["panel_type"];
                                echo "<option value=\"$paneltype\">$paneltype</option>";
                            }
                            ?>
                        </select>
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <input type="date" id="date" name="panel_encode_date" class="form-control" required>
