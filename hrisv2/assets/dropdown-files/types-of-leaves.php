...
<html lang="en">
    <head>
        ...
        <link
            ...
            <style>
                .content-container .sidebar .nav li .sub-nav-second{
                height: 265px;
                }
                .content-container .sidebar .nav li.toggle .sub-nav-second{
                height: 0px;
                }
            </style>
    </head>
    ...
    <div class="content-container" id="collapse">
            ...
            <ul class="nav nav-pills flex-column mb-auto d-block">
                ...
                <li id="second">
                    ...
                    <ul class="sub-nav-second nav nav-pills flex-column mb-auto d-block ms-5">
                        <li>
                            <a href="/hrisv2/assets/dropdown-files/types-of-leaves.php" class="nav-link text-white active">Types of Leaves</a>
                        </li>
                        <li>
        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                <p class="fs-3 text text-white">Types of Leaves</p>
            </div>
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px;">
                <form class="row justify-content-center needs-validation mb-5 pt-5" novalidate>
                    ...
                    <div class="mb-3 col-8">
                        <label for="example-select" class="form-label">Credits:</label>
                        <div class="input-group">
                            <select class="input-group-text" id="salary-grade" required>
                                <option>N/A</option>
                            ...
                            <input type="text" id="code" class="form-control" required>
                            <div class="invalid-feedback">
                                Please provide a valid Credits!
                            </div>
                        </div>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Required # of days to consume per yr:</label>
                        <input type="text" id="code" class="form-control" required>
                        <div class="invalid-feedback">
                            Please provide a valid Required # of days to consume per yr!
                        </div>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Applicable to:</label>
                ...
                <div class="table">
                    <table id="data-table" class="table table-hover mt-5">
                        <thead class="text-white bg-primary">
                            ...
                            <th>Title</th>
                            <th>Credits</th>
                            <th>Required to Consume per yr</th>
                            <th></th>
                            <th>Applicable to</th>
                            <th>Remarks</th>
                            <th></th>
                        ...
                        <tbody>
                            <?php 
                            $sql='SELECT * FROM `leaves` JOIN employee_leaves_period on leaves.elp_no = employee_leaves_period.elp_no;';
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['leave_requiretouse'] ?></td>
                                <td><?php echo $row['elp_name'] ?></td>
                                <td><?php echo $row['leave_gender'] ?></td>
