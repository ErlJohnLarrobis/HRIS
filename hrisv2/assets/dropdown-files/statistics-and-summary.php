...
<html lang="en">
    <head>
        ...
        <link
            ...
            <style>
                .content-container .sidebar .nav li .sub-nav-third{
                height: 310px;
                }
                .content-container .sidebar .nav li.toggle .sub-nav-third{
                height: 0px;
                }
            </style>
    </head>
    ...
    <div class="content-container" id="collapse">
            ...
            <ul class="nav nav-pills flex-column mb-auto d-block">
                ...
                <li id="third">
                    ...
                    <ul class="sub-nav-third nav nav-pills flex-column mb-auto d-block ms-5">
                        ...
                        <li>
                            <a href="/hrisv2/assets/dropdown-files/statistics-and-summary.php" class="nav-link text-white active">Statistics and Summary</a>
                        </li>
                    </ul>
                </li>
                <li>
        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                <p class="fs-3 text text-white">Statistics and Summary</p>
            </div>
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px;">
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action">Manpower Grand Total</a>
                    <a href="#" class="list-group-item list-group-item-action">Summary of Filled Positions</a>
                    <a href="#" class="list-group-item list-group-item-action">Total Head Count</a>
                    <a href="#" class="list-group-item list-group-item-action">Civil Service Eligibility Summary</a>
                    <a href="#" class="list-group-item list-group-item-action">Total Employee Eligibility by Category</a>
                    <a href="#" class="list-group-item list-group-item-action">Employee Rosters</a>
                    <a href="#" class="list-group-item list-group-item-action">Summary of Employee's with Dependent</a>
                    <a href="#" class="list-group-item list-group-item-action">Group Affiliations</a>
                </div>
            </div>
        </section>
    </div>
