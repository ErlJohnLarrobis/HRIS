    ...
    <div class="content-container" id="collapse">
            ...
            <ul class="nav nav-pills flex-column mb-auto d-block">
                ...
                <li id="third">
                    ...
                    <ul class="sub-nav-third nav nav-pills flex-column mb-auto d-block ms-5">
                        ...
                        <li>
                            <a href="/hrisv2/assets/dropdown-files/summary-absences.php" class="nav-link text-white active">Summary Absences</a>
                        </li>
                        <li>
        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                <p class="fs-3 text text-white">Summary Absences</p>
            </div>
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px;">
                <form class="row justify-content-center needs-validation mb-5 pt-5" novalidate>
                    <div class="mb-3 col-8">
                        <label for="example-select" class="form-label">Group:</label>
                        <select class="form-select" id="position" required>
                            <option>All group</option>
                            <option>Groupy</option>
                        </select>
                        <div class="invalid-feedback">Please provide a valid Group !</div>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="example-select" class="form-label">Employee ID:</label>
                        <input type="text" class="form-control">
                        <div class="invalid-feedback">Please provide a valid ID !</div>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="example-select" class="form-label">Format:</label>
                        <select class="form-select" id="position" required>
                            <option>1</option>
                            <option>2</option>
                        </select>
                        <div class="invalid-feedback">Please provide a valid Format !</div>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="example-select" class="form-label">Month of:</label>
                        <select class="form-select" id="position" required>
