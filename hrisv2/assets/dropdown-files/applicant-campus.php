    ...
    <div class="content-container" id="collapse">
            ...
            <ul class="nav nav-pills flex-column mb-auto d-block">
                <li id="first">
                    ...
                    <ul class="sub-nav nav nav-pills flex-column mb-auto d-block ms-5">
                        ...
                        <li>
                            <a
                                href="/hrisv2/assets/dropdown-files/applicant-campus.php"
                                class="nav-link active text-white">Applicants by Campus</a>
                        </li>
                        <li>
                            <a
        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                <p class="fs-3 text text-white">Applicant by Campus</p>
                <ul class="nav nav-pills">
                    <li>
                        <a href="" class="nav-link bg-white">Applicants</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/by-date.php" class="nav-link text-white">By Date</a>
                    </li>
                    <li>
                        <a href="" class="nav-link text-white">Search</a>
                    </li>
                </ul>
            </div>
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -160px;">
                <form
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <select class="form-select" id="position" required="required">
                            <option>ALL</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <div class="input-group">
                            <select class="form-select" id="cba" required="required">
                                <option>ALL</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <div class="input-group">
                            <select class="form-select" id="status" required="required">
                                <option>ALL</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                ...
                <div class="table">
                    <table id="data-table" class="table table-hover mt-5">
                        ...
                        <tbody>
                            <?php 
                            $sql="SELECT * FROM `employee_applicants` JOIN positions on employee_applicants.position_no = positions.position_no JOIN campuses on employee_applicants.campus_no = campuses.campus_no;";
                            ...
                            ?>
                            <tr>
                                <td><?php echo htmlentities($row['applicant_encode_date']) ?></td>
                                <td><?php echo htmlentities($row['position_title']) ?></td>
                                <td><?php echo htmlentities($row['campus_title']) ?></td>
                                <td><?php echo htmlentities($row['applicant_no']) ?></td>
                                <td>
                                    <button type="button" class="btn btn-success">view</button> <button class="btn btn-info">inline</button>
                                </td>
                            </tr>
                            <?php endwhile ?>
                        </tbody>
