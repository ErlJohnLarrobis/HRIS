    ...
    <div class="content-container" id="collapse">
            ...
            <ul class="nav nav-pills flex-column mb-auto d-block">
                ...
                <li id="second">
                    ...
                    <ul class="sub-nav-second nav nav-pills flex-column mb-auto d-block ms-5">
                        ...
                        <li>
                            <a href="/hrisv2/assets/dropdown-files/summary.php" class="nav-link text-white active">Summmary</a>
                        </li>
                        <li>
        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                <p class="fs-3 text text-white">Summary</p>
                <ul class="nav nav-pills">
                    <li>
                        <a href="/hrisv2/assets/dropdown-files/summary.php" class="nav-link bg-white">Summary</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/summary_consumed-leaves.php" class="nav-link text-white">Consumed Leaves</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/summary_leave-balance.php" class="nav-link text-white">Leave Balance</a>
                    </li>
                </ul>
            </div>
            <div class="container bg-light shadow-lg rounded py-3">
                <form class="row justify-content-center needs-validation mb-5 pt-5" novalidate>
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <input type="text" id="name" class="form-control" placeholder="start" required disabled>
                        <input type="text" id="name" class="form-control" placeholder="end" required disabled>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Leaves:</label>
                        <input type="text" id="name" class="form-control" required>
                        <div class="invalid-feedback">
