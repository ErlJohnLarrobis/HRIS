        ...
        <section class="content">
            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -150px;">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $sql1 = "INSERT INTO employee_applicants (applicant_fname, applicant_mname, applicant_lname, applicant_mobile,
                    applicant_email, applicant_barangay, applicant_town, applicant_province, applicant_zipcode, applicant_bday, 
                    applicant_age, applicant_gender, applicant_encode_date, applicant_education, applicant_experience, 
                    applicant_eligibity) VALUES ('$fname', '$mname', '$lname', '$contact', '$email', 
                    '$brgy', '$town', '$province', '$zipcode', '$birthdate', '$age', '$gender', '$dateapply', '$education',
                     '$workexperience', '$eligibility')";
                    mysqli_query($conn, $sql1);

                    $table1_id = mysqli_insert_id($conn);

                    $sql2 = "INSERT INTO positions (position_title, table1_id) VALUES ('$position', '$table1_id')";
                    mysqli_query($conn, $sql2);

                    $sql3 = "INSERT INTO specializations (special_title, table1_id) VALUES ('$specialization', '$table1_id')";
                ...
                <form
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <select class="form-select" id="position" name="position" required="required">
                            ...
                            <option>Vice President for Academic Affairs</option>
                            <option>Vice President for Operations</option>
                            <option>Vice President for External Affairs</option>
                            <option>Vice President for Administration</option>
                            <option>Human Resource Management Officer</option>
                            <option>Human Resource Management Information System</option>
                            <option>Human Resource Secretary</option>
                            <option>External Auditor</option>
                            <option>Accounting Staff I</option>
                            <option>Accounting Staff II</option>
                            <option>Cashier Clerk I</option>
                            <option>OIC, Registrar</option>
                            <option>Register Clerk I</option>
                            <option>Register Clerk II</option>
                            <option>Guidance Counselor</option>
                            <option>Guidance Secretary</option>
                            <option>Librarian</option>
                            <option>Library Staff</option>
                            <option>College Dean</option>
                            <option>College Head</option>
                            <option>Instructor</option>
                            <option>Instructress</option>
                            <option>High School Teacher</option>
                            <option>High School Teacher</option>
                            <option>Elementary Teacher</option>
                            <option>Monitoring Staff</option>
                            <option>Janitor</option>
                            <option>Janitress</option>
                            <option>Janitress</option>
