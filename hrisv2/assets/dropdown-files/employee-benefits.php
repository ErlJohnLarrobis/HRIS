        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                ...
                <ul class="nav nav-pills">
                    <li>
                        <a href="/hrisv2/assets/dropdown-files/employee-benefits.php" class="nav-link bg-white">Set Benefits</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/employee-benefits_summary.php" class="nav-link text-white">Summary</a>
                    </li>
                </ul>
            </div>
