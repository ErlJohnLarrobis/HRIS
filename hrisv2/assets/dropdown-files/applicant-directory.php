    ...
    <div class="content-container" id="collapse">
                    ...
                    <ul class="sub-nav nav nav-pills flex-column mb-auto d-block ms-5">
                        ...
                        <li>
                            <a
                                ...
                                class="nav-link">Applicants by Campus</a>
                        </li>
                        <li>
                            <a
                        ...
                        <li>
                            <a
                                ...
                                class="nav-link active text-white">Applicant Directory</a>
                        </li>
                        <li>
                            <a
        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                <p class="fs-3 text text-white">Applicant Directory</p>
            </div>
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px;">
                <form
                    ...
                    <div class="mb-3 col-8">
                        <label for="lastname" class="form-label">Applicant Lastname:</label>
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <div class="invalid-feedback">Please provide a Campus !</div>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="type" class="form-label">Type:</label>
                        <div class="input-group">
                            <select class="form-select" id="type" required="required">
                                <option>ALL</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <select class="form-select"  id="position" required="required">
                            <option>ALL</option>
                            <?php
                                    $result = mysqli_query($conn, "SELECT * FROM employee_applicants_positions");
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        $select = $row["aposition_title"];
                                        echo "<option value=\"$select\">$select</option>";
                                    }
                            ?>
                        </select>
