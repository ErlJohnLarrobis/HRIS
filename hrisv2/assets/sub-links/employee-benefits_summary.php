    ...
    <div class="content-container" id="collapse">
            ...
            <ul class="nav nav-pills flex-column mb-auto d-block">
                ...
                <li id="second">
                    ...
                    <ul class="sub-nav-second nav nav-pills flex-column mb-auto d-block ms-5">
                        ...
                        <li>
                            <a href="/hrisv2/assets/dropdown-files/employee-benefits.php" class="nav-link text-white active">Employee Benefits</a>
                        </li>
                        <li>
        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                <p class="fs-3 text text-white">Employee Benefits</p>
                <ul class="nav nav-pills">
                    <li>
                        <a href="/hrisv2/assets/dropdown-files/employee-benefits.php" class="nav-link text-white">Set Benefits</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/employee-benefits_summary.php" class="nav-link bg-white">Summary</a>
                    </li>
                </ul>
            </div>
            <div class="container bg-light shadow-lg rounded py-3">
                <form class="row justify-content-center needs-validation mb-5 pt-5" novalidate>
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <div class="invalid-feedback">Please provide a valid Department/Office !</div>
                    </div>
                    <div class="col-8">
