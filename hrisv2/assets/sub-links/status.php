                ...
                <div class="table">
                    <table class="table mt-5">
                        ...
                        <tbody>
                            <tr>
                                <td>dsa</td>
                                <td class="d-flex gap-1 float-end pe-5"><button class="btn btn-info">Edit</button><button class="btn btn-danger">Delete</button></td>
                            </tr>
                            <tr>
                                <th></th>
                                <th class="d-flex gap-1 float-end pe-5"><button class="btn btn-info">Edit</button><button class="btn btn-danger">Delete</button></th>
                            </tr>
                        </tbody>
                    </table>
                </div>
