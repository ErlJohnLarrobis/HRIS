        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li>
                        <a href="/hrisv2/assets/sub-links/plantilla-reports.php" class="nav-link bg-white">Reports</a>
                    </li>
                    <li>
            ...
            <div class="container bg-light shadow-lg rounded py-3 d-flex flex-column gap-3">
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action">Summary of Educational Profile by Campus</a>
                    <a href="#" class="list-group-item list-group-item-action">Summary of Male and Female Employees</a>
                </div>
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action">List of Employees Educational Profile</a>
                    <a href="#" class="list-group-item list-group-item-action">List of Employees by Gender</a>
                </div>
            </div>
        </section>
    </div>
