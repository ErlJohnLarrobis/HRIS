        ...
        <section class="content">
            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px; min-height: 220px;">
                ...
                <div class="tab-header">
                    <ul class="nav nav-pills nav-fill gap-2">
                        ...
                        <li class="nav-item border border-primary rounded">
                            <a href="/hrisv2/assets/sub-links/presonal-data_group-affiliations.php" class="nav-link">Group Affiliations</a>
                        </li>
                        <li class="nav-item bg-primary rounded">
                ...
                <form class="row justify-content-center needs-validation mb-5">
                    ...
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Inclusive Dates:</label>
                        <input type="text" class="form-control" required placeholder="start" disabled>
                        <input type="text" class="form-control" required placeholder="end" disabled>
                    </div>
                    <div class="mb-3 col-8">
