            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px; min-height: 220px;">
                ...
                <form class="row justify-content-center needs-validation mb-5">
                    <div class="mb-3 col-8">
                        ...
                        <div class="input-group">
                            <select class="form-select" id="salary-grade" name="position" required>
                                <option selected disabled value="<?php echo $row1['orga_title']?>"><?php echo $row1['orga_title']?></option>
                                <?php
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <input type="text" class="form-control" value="<?php echo $row1['org_position']?>" required>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Inclusive Dates:</label>
                        <input type="text" class="form-control" value="<?php echo $row1['org_start']?>" required placeholder="start" disabled>
                        <input type="text" class="form-control" value="<?php echo $row1['org_end']?>" required placeholder="end" disabled>
                    </div>
                    <div class="mb-3 col-8">
