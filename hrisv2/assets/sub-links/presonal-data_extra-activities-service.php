        ...
        <section class="content">
            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px; min-height: 220px;">
                ...
                if($_SERVER['REQUEST_METHOD'] == 'POST'){
                    ...
                    if (isset($_POST['islifetime']) && $_POST['islifetime'] == '1') {
                        $islifetime = 1;
                    } else{
                        $islifetime = 0;
                    }

                    $sqlinsert ="INSERT INTO `career_activities`(`activity_title`, `activity_hours`, `activity_position`, `activity_islifetime`, `activity_encode_date`, `user_no`) 
                    SELECT '$name','$hours','$position','$islifetime',NOW(), b.user_no 
                    FROM `users` b
                    WHERE b.user_id='$id'";
                ...
                <form class="row justify-content-center needs-validation mb-5" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?emp_id=' . $id;?>">
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <input class="form-check-input" type="checkbox" name="islifetime" value="1" id="flexCheckDefault">
