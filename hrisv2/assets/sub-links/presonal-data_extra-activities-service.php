            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px; min-height: 220px;">
                ...
                ?>
                    <ul class="nav nav-pills nav-fill gap-2">
                        ...
                        <li class="nav-item border border-primary rounded">
                            <a href="/hrisv2/assets/sub-links/presonal-data_extra-activities-service.php?emp_id=<?php echo $id?>" class="nav-link active">Extra Activities or Services</a>
                        </li>
                        <li class="nav-item border border-primary rounded">
                ...
                <hr>
                <?php 
                $sql1 = "SELECT * FROM users LEFT JOIN career_activities ON users.user_no = career_activities.user_no WHERE user_id='$id'";
                $res = $conn->query($sql1);
                ...
                <form class="row justify-content-center needs-validation mb-5">
                    <div class="mb-3 col-8">
                        ...
                        <input type="text" class="form-control" value="<?php echo $row1['activity_title']?>" required>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Inclusive Dates:</label>
                        <input type="text" class="form-control" value="<?php echo $row1['activity_start']?>" required placeholder="start" disabled>
                        <input type="text" class="form-control" value="<?php echo $row1['activity_end']?>" required placeholder="end" disabled>
                        <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" <?php if($row1['activity_islifetime'] == 1) echo 'checked';?>>
                        <label class="form-check-label" for="flexCheckDefault">
                            If checked, extra activities or services is lifetime.
                        </label>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label"># of Hours:</label>
                        <input type="text" class="form-control" value="<?php echo $row1['activity_hours']?>" required>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Position/Nature of Work:</label>
                        <input type="text" class="form-control" value="<?php echo $row1['activity_position']?>" required>
                    </div>
                    <div class="mb-3 col-8">
                ...
                <div class="table">
                    <label>Extra Activities or Services Summary</label>
                    <table id="data-table" class="table table-hover mt-5">
                        ...
                        <tbody>
                            <td><?php echo $row1['activity_title']?></td>
                            <td><?php echo $row1['activity_start']?><?php echo $row1['activity_end']?></td>
                            <td><?php echo $row1['activity_hours']?></td>
                            <td><?php echo $row1['activity_position']?></td>
                        </tbody>
                    </table>
                </div>  
                <?php endwhile?> 
