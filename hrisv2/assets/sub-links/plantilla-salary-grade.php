        ...
        <section class="content" style="height: 100vh;">
            ...
            <div class="container bg-light shadow-lg rounded py-3">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $sql = "INSERT INTO salary_grades (sg_number, sg_remark, sg_order) VALUES ('$sg_no', '$description', '$order')";
                ...
                <div class="table">
                    <table id="data-table" class="table table-hover mt-5">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $row['sg_number'] ?></td>
                                                <td><?php echo $row['sg_remark'] ?></td>
                                                <td><?php echo $row['sg_order'] ?></td>
