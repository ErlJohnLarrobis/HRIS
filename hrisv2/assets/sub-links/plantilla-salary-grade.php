        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li>
                        <a href="/hrisv2/assets/sub-links/plantilla-salary-grade.php" class="nav-link bg-white">Salary Grade</a>
                    </li>
                    <li>
            ...
            <div class="container bg-light shadow-lg rounded py-3">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    if(isset($_POST['delete-button'])){
                        ...
                        $sqldelete="UPDATE salary_grades SET sg_delete=1 WHERE sg_no=$iddelete";
                        ...
                        $stmt = $conn->prepare("INSERT INTO salary_grades (sg_number, sg_remark, sg_order, sg_encode_date) VALUES (?,?,?, NOW())");

                        $stmt->bind_param("isi",$sg_no,$description,$order);
                ...
                ?>
                <form class="row justify-content-center needs-validation mb-5 pt-5" method='POST' action='<?php echo $_SERVER['PHP_SELF']; ?>' novalidate>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">SG #:</label>
                        <input type="text" id="sg_no" name="sg_no" class="form-control" required>
                        <div class="invalid-feedback">
                            Please provide a valid SG #.!
                        </div>
                    </div>
                    <div class="mb-3 col-8">
                ...
                <div class="table">
                    <table id="data-table" class="table table-hover mt-5">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM salary_grades WHERE sg_delete=0";
                                            ...
                                            <tr>
                                                <td><?php echo htmlentities($row['sg_number']) ?></td>
                                                <td><?php echo htmlentities($row['sg_remark']) ?></td>
                                                <td><?php echo htmlentities($row['sg_order']) ?></td>
                                                <td class="d-flex">
                                                    <button class="btn btn-success"><a class="text-decoration-none text-white" href="/hrisv2/assets/data-modifier/plantilla-salary-grade-update.php?id=<?php echo $row['sg_no']?>">Edit</a></button>&nbsp;
                                                    <form method='post' action='<?php echo $_SERVER['PHP_SELF']; ?>'><input type='hidden' name='delete-button' value='<?php echo $row['sg_no'] ?>'><input class="btn btn-danger" type='submit' value='Delete'></form>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
