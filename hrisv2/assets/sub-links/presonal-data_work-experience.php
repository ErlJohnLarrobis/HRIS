            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px; min-height: 220px;">
                ...
                <form class="row justify-content-center needs-validation mb-5">
                    <div class="mb-3 col-8">
                        ...
                        <input type="text" class="form-control" value="<?php echo $row['ew_position']?>" required>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Company/Agency:</label>
                        <input type="text" class="form-control" value="<?php echo $row['ew_company']?>" required>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Address:</label>
                        <input type="text" class="form-control" value="<?php echo $row['ew_address']?>" required>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Tenureship/CS Status:</label>
                        <input type="text" class="form-control" value="<?php echo $row['ew_tenure']?>" required>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Salary:</label>
                        <input type="text" class="form-control" value="<?php echo $row['ew_salary']?>" required>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Period:</label>
                        <input type="text" class="form-control" value="<?php echo $row['ew_start']?>" required placeholder="start" disabled>
                        <input type="text" class="form-control" value="<?php echo $row['ew_end']?>" required placeholder="end"disabled>
                    </div>
                    <div class="mb-3 col-8">
                ...
                <div class="table">
                    ...
                    <table id="data-table" class="table table-hover mt-5">
                        ...
                        <tbody>
                            <tr><?php echo $row['ew_start']?></tr>
                            <tr><?php echo $row['ew_end']?></tr>
                            <tr><?php echo $row['ew_address']?></tr>
                            <tr><?php echo $row['ew_tenure']?></tr>
                            <tr><?php echo $row['ew_salary']?></tr>
                            <tr><?php echo $row['ew_company']?></tr>
                        </tbody>
                    </table>
                </div>
                <?php endwhile?>   
