        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li>
                        <a href="/hrisv2/assets/sub-links/request-document_reports.php" class="nav-link bg-white">Reports</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/request-document_documents.php" class="nav-link text-white">Documents</a>
                    </li>
                </ul>
            </div>
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -160px;">
                <form class="row justify-content-center needs-validation mb-5 pt-5" novalidate>
                    ...
                    <div class="mb-3 col-8">
                        <label for="example-select" class="form-label">Document:</label>
                    ...
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Date Range:</label>
                        <input type="text" id="code" class="form-control" placeholder="Start" required disabled>
                        <input type="text" id="code" class="form-control" placeholder="End" required disabled>
                        <div class="invalid-feedback">
