        ...
        <section class="content">
            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px; min-height: 220px;">
                ...
                if($_SERVER['REQUEST_METHOD']=='POST'){
                    ...
                    $sql_seminar = "SELECT seminar_no FROM seminar_types WHERE seminar_name = '$type'";
                    $result_seminar = mysqli_query($conn, $sql_seminar);
                    if (mysqli_num_rows($result_seminar) > 0) {
                    $row_seminar = mysqli_fetch_assoc($result_seminar);
                    $seminar_no = $row_seminar['seminar_no'];
                    } else {
                    die("Seminar not found");
                    }

                    $sqlinsert = "INSERT INTO `employee_seminars`(`seminar_no`, `es_title`, `es_venue`, `es_hours`, `es_service`, `es_conducted`, `es_remark`, `es_encode_date`,`user_no`) 
                    SELECT '$seminar_no','$seminar','$venue','$hrs','$ros','$conducted','$remark',NOW(), b.user_no 
                    FROM `users` b
                    WHERE b.user_id='$id'";
                ...
                <form class="row justify-content-center needs-validation mb-5" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?emp_id=' . $id;?>">
                    <div class="mb-3 col-8">
                        ...
                        <input type="text" class="form-control" name="seminar">
                    </div>
                    <div class="mb-3 col-8">
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <input type="text" class="form-control" name="start" placeholder="start" disabled>
                        <input type="text" class="form-control" name="end" placeholder="end" disabled>
                    </div>
                    <div class="mb-3 col-8">
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <div class="input-group">
                            <select class="form-select" id="salary-grade" name="type">
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <input type="text" class="form-control" name="ros">
                    </div>
                    <div class="mb-3 col-8">
