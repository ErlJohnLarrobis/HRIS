    ...
    <div class="content-container" id="collapse">
        ...
        <section class="content">
            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px; min-height: 220px;">
                ...
                <?php 
                include_once 'connection.php';
                    $sql = "SELECT * FROM `users` LEFT JOIN employee_educations ON users.user_no = employee_educations.user_no LEFT JOIN graduates ON employee_educations.grad_no = graduates.grad_no WHERE user_id='$id';";
                    $res = $conn->query($sql);
                    ...
                    <form class="row justify-content-center needs-validation mb-5">
                        <div class="mb-3 col-8">
                            ...
                            <div class="input-group">
                                <select class="form-select" id="salary-grade" name="position" required>
                                    <option selected disabled value="<?php echo $row['grad_name']?>"><?php echo $row['grad_name']?></option>
                                    <?php
                        ...
                        <div class="mb-3 col-8">
                            ...
                            <input type="text" class="form-control" value="<?php echo $row['eeduc_course']?>" required>
                            <input class="form-check-input" type="radio" name="flexRadioDefault" <?php if ($row['eeduc_graduate'] == 1) echo "checked";?> id="flexRadioDefault1">
                            <label class="form-check-label" for="flexRadioDefault1">
                                Masteral
                            </label>
                            <input class="form-check-input" type="radio" name="flexRadioDefault" <?php if ($row['eeduc_graduate'] == 2) echo "checked";?> id="flexRadioDefault1">
                            <label class="form-check-label" for="flexRadioDefault1">
                                Doctoral
                            </label>
                            <input class="form-check-input" type="radio" name="flexRadioDefault" <?php if ($row['eeduc_graduate'] == 0) echo "checked";?> id="flexRadioDefault1">
                            <label class="form-check-label" for="flexRadioDefault1">
                                Others
                            </label>
                        ...
                        <div class="mb-3 col-8">
                            ...
                            <input type="text" class="form-control" value="<?php echo $row['eeduc_school']?>" required>
                        </div>
                        <div class="mb-3 col-8">
                            <label for="simpleinput" class="form-label">Address:</label>
                            <input type="text" class="form-control" value="<?php echo $row['eeduc_school_address']?>" required>
                        </div>
                        <div class="mb-3 col-8">
                            <label for="simpleinput" class="form-label">Period of Attendance:</label>
                            <input type="text" class="form-control" value="<?php echo $row['eeduc_period_start']?>" required placeholder="Year start">
                            <input type="text" class="form-control" value="<?php echo $row['eeduc_period_end']?>" required placeholder="Year end">
                        </div>
                        <div class="mb-3 col-8">
                            <label for="simpleinput" class="form-label">Year Graduated:</label>
                            <div class="input-group">
                                <select class="input-group-text" id="salary-grade" name="position" required>
                                    <option selected disabled value="<?php echo $row['eeduc_month']?>">
                                    <?php $month_number = $row['eeduc_month'];
                                ...
                                <input type="text" class="form-control" value="<?php echo $row['eeduc_yr_graduated']?>" required>
                            </div>
                        </div>
                        <div class="mb-3 col-8">
                            <label for="simpleinput" class="form-label">Earned Units:</label>
                            <input type="text" class="form-control" value="<?php echo $row['eeduc_units']?>" required>
                            <p>if not yet graduated</p>
                        </div>
                        <div class="mb-3 col-8">
                            <label for="simpleinput" class="form-label">Scholarship/Academic Honor Received:</label>
                            <input type="text" class="form-control" value="<?php echo $row['eeduc_honor']?>" required>
                        </div>
                        <div class="mb-3 col-8">
                        ...
                        <table id="data-table" class="table table-hover mt-5">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo $row['eeduc_school']?></td>
                                    <td><?php echo $row['eeduc_course']?></td>
                                    <td><?php echo trim($row['eeduc_period_start'].'-'.$row['eeduc_period_end'])?></td>
                                    <td><?php echo $row['eeduc_units']?></td>
                                    <td><?php echo $row['eeduc_yr_graduated']?></td>
                                    <td><?php echo $row['eeduc_honor']?></td>
                                </tr>
                            </tbody>
