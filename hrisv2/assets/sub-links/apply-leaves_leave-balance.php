        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li>
                        <a href="/hrisv2/assets/sub-links/apply-leaves_used-leaves.php" class="nav-link text-white">Used Leaves</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/apply-leaves_leave-balance.php" class="nav-link bg-white">Leave Balance</a>
                    </li>
                </ul>
            </div>
