        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                ...
                <ul class="nav nav-pills">
                    <li>
                        <a href="/hrisv2/assets/dropdown-files/summary.php" class="nav-link text-white">Summary</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/summary_consumed-leaves.php" class="nav-link bg-white">Consumed Leaves</a>
                    </li>
                    <li>
            ...
            <div class="container bg-light shadow-lg rounded py-3">
                <form class="row justify-content-center needs-validation mb-5 pt-5" novalidate>
                    ...
                    <div class="mb-3 col-8">
                        <label for="example-select" class="form-label">Department/Office:</label>
                    ...
                    <div class="mb-3 col-8">
                        <label for="example-select" class="form-label">Leaves:</label>
                        <select class="form-select" id="position" required>
                            <option disabled selected>Select One</option>
                            <option>1</option>
                            <option>2</option>
