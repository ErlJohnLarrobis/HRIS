            ...
            include_once 'connection.php';
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    if(isset($_POST['delete-button'])){
                        ...
                        $sqldelete = "UPDATE employee_applicants_assessments SET ass_delete=1 WHERE ass_no=$iddelete;";
                        ...
                        $stmt = $conn->prepare("INSERT INTO `employee_applicants_assessments`(`ass_title`) VALUES (?)");
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                ...
                                <form method='post' action='<?php echo $_SERVER['PHP_SELF']; ?>'><input type='hidden' name='delete-button' value='<?php echo htmlentities($row['ass_no']) ?>'><input class="btn btn-danger" type='submit' value='Delete'></form>
                            </td>
                        </tr>
                        <?php endwhile ?>
                    </tbody>
