        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                ...
                <ul class="nav nav-pills">
                    <li>
                        <a href="/hrisv2/assets/links/separations.php" class="nav-link text-white">Separations</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/separations_summary.php" class="nav-link bg-white">Summary</a>
                    </li>
                </ul>
            </div>
            <div class="container bg-light shadow-lg rounded py-3">
                <form class="row justify-content-center needs-validation mb-5 pt-5" novalidate>
                    <div class="mb-3 col-8">
                        <label for="example-select" class="form-label">Nature of Separation:</label>
                    ...
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Employee Lastname:</label>
