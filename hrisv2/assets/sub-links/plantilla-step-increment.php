        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li>
                        <a href="/hrisv2/assets/sub-links/plantilla-step-increment.php" class="nav-link bg-white">Step Increment</a>
                    </li>
                    <li>
            ...
            <div class="container bg-light shadow-lg rounded py-3">
                <?php 
                    if($_SERVER['REQUEST_METHOD'] == 'POST'){
                        ...
                        $sql = "INSERT INTO salary_grades_steps (sg_no, sgs_number, sgs_amount, sgs_order) VALUE ('$sg','$steps','$amount','$order')";
                ...
                <form class="row justify-content-center needs-validation mb-5 pt-5" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" novalidate>
                    <div class="mb-3 col-8">
                        ...
                        <select class="form-select" id="salary-grade" name="salary-grade" required>
                            ...
                            <?php
                            $result = mysqli_query($conn, "SELECT DISTINCT sg_no FROM salary_grades_steps");
                    ...
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Step #:</label>
                        <input type="number"  id="code" class="form-control" name="step" required>
                        <div class="invalid-feedback">
                            Please provide a valid Step #!
                        </div>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Amount:</label>
                        <input type="text" id="name" class="form-control" name="amount" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <input type="text" id="name" class="form-control" name="order" required>
                        <div class="invalid-feedback">
