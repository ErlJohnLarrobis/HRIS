            ...
            <div class="container bg-light shadow-lg rounded py-3">
                <?php 
                    if($_SERVER['REQUEST_METHOD'] == 'POST'){
                        $stmt = $conn->prepare("INSERT INTO salary_grades_steps (sg_no, sgs_number, sgs_amount, sgs_order) VALUE (?,?,?,?)");

                        $stmt->bind_param("isii",$sg,$steps,$amount,$order);
                ...
                <form class="row justify-content-center needs-validation mb-5 pt-5" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" novalidate>
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <input type="number" class="form-control" name="step" id="step" onkeyup="copyinputvalue()" required>
                        <div class="invalid-feedback">
