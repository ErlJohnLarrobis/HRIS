        ...
        <section class="content" style="height: 100vh;">
            ...
            <div class="container bg-light shadow-lg rounded py-3">
                <?php
                    ...
                    $sql="INSERT INTO employee_plantilla (position_no, plantilla_itemno, user_no, plantilla_place) VALUES ('$position', '$itemno', (SELECT user_no FROM users WHERE user_id = '$id'), '$place')";
                ...
                <div class="table">
                    <table id="data-table" class="table table-hover mt-5">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql='SELECT * FROM `employee_plantilla` JOIN users on employee_plantilla.user_no = users.user_no JOIN positions on employee_plantilla.position_no = positions.position_no;';
                                            ...
                                            <tr>
                                                <td><?php echo trim($row["user_lname"].', '.$row["user_fname"].' '.$row["user_mname"]) ?></td>
                                                <td><?php echo $row['position_title'] ?></td>
                                                <td><?php echo $row['plantilla_itemno'] ?></td>
                                                <td><?php echo $row['sg_no'] ?></td>
                                                <td><?php echo $row['plantilla_place'] ?></td>
                                            </tr>
                                            <?php endwhile ?>
                                        </tbody>
                                    </table>
