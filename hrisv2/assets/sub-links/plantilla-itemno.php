        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                ...
                <ul class="nav nav-pills">
                    <li>
                        <a href="/hrisv2/assets/links/plantilla.php" class="nav-link text-white">Position</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/plantilla-itemno.php" class="nav-link bg-white">Item no.</a>
                    </li>
                    <li>
            ...
            <div class="container bg-light shadow-lg rounded py-3">
                <?php
                    ...
                    $sql="INSERT INTO employee_plantilla (position_no, plantilla_itemno, user_no, plantilla_place) VALUES ('$position_no', '$itemno', (SELECT user_no FROM users WHERE user_id = '$id'), '$place')";
                ...
                ?>
                <form class="row justify-content-center needs-validation mb-5 pt-5" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" novalidate>
                    ...
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Item no.:</label>
                        <input type="text" id="code" class="form-control" name="item_no" required>
                        <div class="invalid-feedback">
                            Please provide a valid Item No.!
                        </div>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Employee ID:</label>
                        <input type="text" id="name" class="form-control" name="emp_id" required>
                        <div class="invalid-feedback">
                            Please provide a valid Employee ID!
                        </div>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Place of Assignment:</label>
                        <input type="text" id="name" class="form-control" name="place_assign" required>
                        <div class="invalid-feedback">
                            Please provide a valid Place of Assignment!
                        </div>
                    </div>
                    <div class="col-8">
                ...
                <div class="table">
                    <table id="data-table" class="table table-hover mt-5">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql='SELECT * FROM `employee_plantilla` JOIN users on employee_plantilla.user_no = users.user_no JOIN positions on employee_plantilla.position_no = positions.position_no WHERE plantilla_delete=0;';
                                            ...
                                            <tr>
                                                <td><?php echo htmlentities(trim($row["user_lname"].', '.$row["user_fname"].' '.$row["user_mname"])) ?></td>
                                                <td><?php echo htmlentities($row['position_title']) ?></td>
                                                <td><?php echo htmlentities($row['plantilla_itemno']) ?></td>
                                                <td><?php echo htmlentities($row['sg_no']) ?></td>
                                                <td><?php echo htmlentities($row['plantilla_place']) ?></td>
                                            </tr>
                                            <?php endwhile ?>
                                        </tbody>
                                    </table>
