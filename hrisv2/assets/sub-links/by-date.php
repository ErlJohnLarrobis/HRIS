        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                ...
                <ul class="nav nav-pills">
                    <li>
                        <a href="/hrisv2/assets/dropdown-files/applicant-campus.php" class="nav-link text-white">Applicants</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/by-date.php" class="nav-link bg-white">By Date</a>
                    </li>
                    <li>
