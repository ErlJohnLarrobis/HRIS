            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px; min-height: 220px;">
                ...
                ?>
                    <ul class="nav nav-pills nav-fill gap-2">
                        ...
                        <li class="nav-item border border-primary rounded">
                            <a href="/hrisv2/assets/sub-links/presonal-data_children-data.php?emp_id=<?php echo $id?>" class="nav-link active">Children's Data</a>
                        </li>
                        <li class="nav-item border border-primary rounded">
                ...
                if($_SERVER['REQUEST_METHOD']  == 'POST'){
                    ...
                    $sqlinsert = "INSERT INTO `employee_childrens`(`child_name`, `child_bday`, `child_gender`, `child_encode_date`, `user_no`)
                    SELECT '$name','$birthdate','$gender',NOW(), b.user_no 
                    FROM `users` b
                    WHERE b.user_id='$id'";
                ...
                <form class="row justify-content-center needs-validation mb-5" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?emp_id=' . $id;?>">
                    <div class="mb-3 col-8">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Lastname, Firstname Middlename" required>
                    </div>
                    <div class="mb-3 col-8">
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <select class="form-select" id="salary-grade" name="gender" required>
                ...
                <div class="table">
                    ...
                    <table id="data-table" class="table table-hover mt-5">
                        ...
                        <?php 
                        $sql1="SELECT * FROM users LEFT JOIN employee_childrens ON users.user_no = employee_childrens.user_no WHERE user_id='$id' AND child_delete=0;";
                        $res1 = $conn->query($sql1);
                        while($row1=$res1->fetch_assoc()):
                        ?>
                        <tbody>
                            <tr>
                                <td><?php echo $row1['child_name']?></td>
                                <td><?php echo $row1['child_bday']?></td>
                                <td>
                                    <?php
                                    $dateOfBirth = $row1['child_bday'];
                                ...
                                <td><?php echo $row1['child_gender']?></td>
                            </tr>
                        </tbody>
                        <?php endwhile?>
                    </table>
