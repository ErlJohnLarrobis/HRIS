        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                ...
                <ul class="nav nav-pills">
                    <li>
                        <a href="/hrisv2/assets/links/rewards-awards.php" class="nav-link text-white">Awards</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/rewards-awards_rubrics.php" class="nav-link bg-white">Rubrics</a>
                    </li>
                    <li>
            ...
            <?php 
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    if(isset($_POST['delete-button'])){
                        ...
                        $sqldelete = "UPDATE employee_awards_rubrics SET rubrics_delete=1 WHERE rubrics_no=$id";
                    ...
                    $sqlinsert = "INSERT INTO `employee_awards_rubrics`(`aeval_no`, `at_no`, `rubrics_percent`, `rubrics_encode_date`) 
                    VALUES ('$aeval_no','$at_no','$percentage',NOW())";
            ...
            ?>
                <form class="row justify-content-center needs-validation mb-5 pt-5" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" novalidate>
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <input type="number" id="code" class="form-control" name="percentage" required>
                        <div class="invalid-feedback">
                ...
                <div class="table">
                    <table id="data-table" class="table table-hover mt-5">
                        ...
                        if (mysqli_connect_errno()) {
                            ...
                            $sql="SELECT * FROM `employee_awards_rubrics` JOIN employee_awards_types ON employee_awards_rubrics.at_no = employee_awards_types.at_no JOIN employee_awards_evaluations on employee_awards_rubrics.aeval_no = employee_awards_evaluations.aeval_no WHERE rubrics_delete=0";
                            $res = $conn->query($sql);
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $row['aeval_title']?></td>
                                <td><?php echo $row['rubrics_percent']?></td>
                                <td class="d-flex">
                                    <button class="btn btn-success"><a class="text-decoration-none text-dark" href="/hrisv2/assets/data-modifier/rewards-awards-rubrics-update.php?id=<?php echo $row['rubrics_no']?>">Edit</a></button>&nbsp;
                                    <button class="btn btn-info">evaluation</button>&nbsp;
                                    <form method='post' action='<?php echo $_SERVER['PHP_SELF']; ?>'><input type='hidden' name='delete-button' value='<?php echo $row['rubrics_no'] ?>'><input class="btn btn-danger" type='submit' value='Delete'></form>
                                </td>
                            </tr>
                        <?php 
                        endwhile
