            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -160px;">
                <form class="row justify-content-center needs-validation mb-5 pt-5" novalidate>
                    <div class="mb-3 col-8">
                        ...
                        <select class="form-select" id="salary-grade" required>
                ...
                <div class="table">
                    <table id="data-table" class="table table-hover mt-5">
                        ...
                        if (mysqli_connect_errno()) {
                            ...
                            $sql="SELECT * FROM `employee_awards_types` JOIN employee_awards_rubrics ON employee_awards_types.at_no = employee_awards_rubrics.at_no JOIN employee_awards_evaluations on employee_awards_rubrics.aeval_no = employee_awards_evaluations.aeval_no;";
                            $res = $conn->query($sql);
