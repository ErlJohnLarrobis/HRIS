        ...
        <section class="content" style="height: 100vh;">
            <div class="header bg-primary p-3">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li>
                        <a href="/hrisv2/assets/sub-links/assessment-type.php" class="nav-link text-white">Type</a>
                    </li>
                    <li>
                        <a href="/hrisv2/assets/sub-links/assessment-instrument.php" class="nav-link bg-white">Instrument</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="table">
                <table id="data-table" class="table table-hover mt-5">
                    ...
                    <tbody>
                        <tr>
                            <td>sa</td>
                            <td><button class="btn btn-primary">add</button><button class="btn btn-success">view</button></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><button class="btn btn-primary">add</button><button class="btn btn-success">view</button></td>
