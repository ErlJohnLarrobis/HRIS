        ...
        <section class="content">
            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px; min-height: 220px;">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST'){
                    ...
                    $sqlinsert = "INSERT INTO `employee_recognitions`(`recog_title`, `recog_place`, `recog_granting`, `recog_remark`, `recog_encode_date`, `user_no`)
                    SELECT '$title','$place','$grant','$remark',NOW(), b.user_no 
                    FROM `users` b
                    WHERE b.user_id='$id'";
                ...
                <form class="row justify-content-center needs-validation mb-5" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?emp_id=' . $id;?>">
                    ...
                    <div class="mb-3 col-8">
                        ...
                        <input type="text" class="form-control" name="date" required disabled>
                    </div>
                    <div class="mb-3 col-8">
