            ...
            <div class="container bg-light shadow-lg rounded py-3" style="margin-top: -220px; min-height: 220px;">
                ...
                ?>
                    <ul class="nav nav-pills nav-fill gap-2">
                        ...
                        <li class="nav-item border border-primary rounded">
                            <a href="/hrisv2/assets/sub-links/presonal-data_distric-recognition.php?emp_id=<?php echo $id?>" class="nav-link active">Distinction or Recognition</a>
                        </li>
                        <li class="nav-item border border-primary rounded">
                ...
                <hr>
                <?php 
                $sql1 = "SELECT * FROM users LEFT JOIN employee_recognitions ON users.user_no = employee_recognitions.user_no WHERE user_id='$id';";
                $res1 = $conn->query($sql1);
                while($row1=$res1->fetch_assoc()):
                ?>
                <form class="row justify-content-center needs-validation mb-5">
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Distinction/Recognition Title:</label>
                        <input type="text" class="form-control" value="<?php echo $row1['recog_title']?>" required>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Places:</label>
                        <input type="text" class="form-control" value="<?php echo $row1['recog_place']?>" required>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Date:</label>
                        <input type="text" class="form-control" value="<?php echo $row1['recog_date']?>" required disabled>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Granting Agency/Organization:</label>
                        <input type="text" class="form-control" value="<?php echo $row1['recog_granting']?>" required>
                    </div>
                    <div class="mb-3 col-8">
                        <label for="simpleinput" class="form-label">Remark:</label>
                        <input type="text" class="form-control" value="<?php echo $row1['recog_remark']?>" required>
                    </div>
                    <div class="mb-3 col-8">
                ...
                <div class="table">
                    <label>Distinctions/Recognitions Details</label>
                    <table id="data-table" class="table table-hover mt-5">
                        ...
                        <tbody>
                            <tr>
                                <td><?php echo $row1['recog_title']?></td>
                                <td><?php echo $row1['recog_place']?></td>
                                <td><?php echo $row1['recog_date']?></td>
                                <td><?php echo $row1['recog_granting']?></td>
                                <td><?php echo $row1['recog_remark']?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>  
